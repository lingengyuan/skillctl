...
func TestPackageZIPRejectsUnsafeEntries(t *testing.T) {
	for _, name := range []string{"../escape", "/absolute", "dir/../../escape", "dir\\..\\escape"} {
		t.Run(name, func(t *testing.T) {
			...
			if err := unpackArtifact(data.Bytes(), t.TempDir()); err == nil {
